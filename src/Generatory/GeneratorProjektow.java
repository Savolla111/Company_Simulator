...
public class GeneratorProjektow {
    ...
    public List<Technologia> DodajTechnologie(int ilosc, Projekt projekt) {
        ...
        for (int i = 0; i < ilosc; i++) {
            wylosowanyIndeks = Losuj(0, technologieDoLosowania.size() - 1);
            Technologia technologia = technologieDoLosowania.get(wylosowanyIndeks).Kopiuj();
            ...
            technologieDoLosowania.remove(wylosowanyIndeks);
        }
        return technologie;
    }
